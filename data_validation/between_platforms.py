...
The script uses the subway-cleaned GTFS file generated by the data cleaning step:

- stop_times_subway_cleaned.txt, filtering rows where ``trip_id`` starts with ``1.``
